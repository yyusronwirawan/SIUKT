    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <h4 class="card-title">{{$subTitle}} @if($tahunAngkatan !== null)(Tahun Angkatan {{$tahunAngkatan}})@endif</h4>
                </div>
            </div>
            ...
            {{-- <div class="card-header d-flex justify-content-start" style="margin-right: 5px;">
                <select name="tahun_angkatan" id="tahun_angkatan" onchange="filterTahunAngkatan()" class="selectpicker form-control">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/filter-data-mahasiswa" method="POST">
                    @csrf
...
<script>
    this.datas = new FormData();
        ...
        function filterTahunAngkatan() {
            // var CSRF_TOKEN = document.querySelector('meta[name="csrf-token"]').getAttribute("content");
            // var tahun_angkatan = $("#tahun_angkatan").val();
            // datas.append('tahun_angkatan',tahun_angkatan);
            // datas.append('_token',CSRF_TOKEN);
            // console.log('masuk')
            // $.ajax({
            //      url: "{{route('filter-tahun-angkatan')}}",
            //      method: 'GET',
            //      data: datas,
            //      contentType: false,
            //      processData: false,
