                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex align-items-center list-user-action">
                                    <a href="/cetak-satuan-penurunan/{{$item->id_penurunan_ukt}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Cetak" target="__blank" data-original-title="Cetak">
