        ...
        <section class="sheet padding-10mm" style="margin-top: -30px;">
            ...
            <h3>{{$title}}</h3>
				...
				<div style="margin-top: 20px;">
					<table style="width: 100%;">
						...
						<tr>
							...
							<td>Pengajuan penurunan UKT <strong>Disetujui</strong>.</td>
							@elseif($detail->status_penurunan == 'Tidak Setuju')
							<td>Pengajuan penurunan UKT <strong>Tidak Disetujui</strong>.</td>
							@elseif($detail->status_penurunan == 'Proses')
							<td>Pengajuan penurunan UKT sedang <strong>Diproses</strong>.</td>
							@endif
						</tr>
					</table>
				</div>
				...
				<div style="margin-top: 20px;">
                    ...
                    <tr>
                        <td class="bor">Surat Pengajuan</td>
                        <td class="bor">
                    ...
                    @if ($detail->sktm != null)
                    <tr>
                        <td class="bor">SKTM (Surat Keterangan Tidak Mampu)</td>
                        <td class="bor">
                            @if ($detail->sktm)
                                Terlampir di Sistem
                            @else
                    ...
                    @if ($detail->khs != null)
                    <tr>
                        <td class="bor">KHS (Semester Yang Sedang Berjalan)</td>
                        <td class="bor">
                            @if ($detail->khs)
                                Terlampir di Sistem
                            @else
